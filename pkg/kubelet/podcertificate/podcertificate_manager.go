...
type Manager interface {
	GetPodCertificateCredentialBundle(ctx context.Context, pod PodIdentity, volumeName, path, signerName, keyType string) (*CredentialBundle, error)
...
func (m *IssuingManager) GetPodCertificateCredentialBundle(ctx context.Context, pod PodIdentity, volumeName, path, signerName, keyType string) (*CredentialBundle, error) {
	...
	case credentialStatusFresh:
		...
		return &CredentialBundle{
			...
			CertificateChainPEM: record.certificateChainPEM,
		}, nil
...
func (m *IssuingManager) makeCredentialBundle(ctx context.Context, signerName string, pod PodIdentity, keyType string) (*credentialRecord, error) {
	...
	record := &credentialRecord{
		keyPEM:              keyPEM,
		certificateChainPEM: []byte(req.Status.CertificateChain),
...
func (m *IssuingManager) generateKeyAndProof(keyType string, toBeSigned []byte) (privKey, pubKey any, sig []byte, err error) {
	...
	case "ED25519":
		...
		sig := ed25519.Sign(privKey, toBeSigned)
		return privKey, pubKey, sig, nil
	default:
...
func (m *NoOpManager) GetPodCertificateCredentialBundle(ctx context.Context, pod PodIdentity, volumeName, path, signerName, keyType string) (*CredentialBundle, error) {
