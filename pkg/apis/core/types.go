...
type PodCertificateProjection struct {
	...
	//
	// If omitted or left at 0, kube-apiserver will set a default value of 86400
	// (1 day).
	//
	// kube-apiserver can additionally override this with a shorter value based
	// on a per-signer configuration, and it will reject values less than 3600
	// (1 hour).
	//
	// The signer implementation is then free to issue a certificate with any
	// lifetime *less* than maxExpirationSeconds.
