...
func DiscoveryInterface2Context(i DiscoveryInterface) DiscoveryInterfaceWithContext {
	if i == nil {
		return nil
	}
	...
	return &discoveryInterfaceWrapper{
		ServerGroupsInterfaceWithContext:    ServerGroupsInterface2Context(i),
		ServerResourcesInterfaceWithContext: ServerResourcesInterface2Context(i),
		ServerVersionInterfaceWithContext:   ServerVersionInterface2Context(i),
		OpenAPISchemaInterfaceWithContext:   OpenAPISchemaInterface2Context(i),
		OpenAPIV3SchemaInterfaceWithContext: OpenAPIV3SchemaInterface2Context(i),
		parent:                              i,
	}
}
...
func AggregatedDiscoveryInterface2Context(i AggregatedDiscoveryInterface) AggregatedDiscoveryInterfaceWithContext {
	if i == nil {
		return nil
	}
	...
	return &aggregatedDiscoveryInterfaceWrapper{
		DiscoveryInterfaceWithContext: DiscoveryInterface2Context(i),
		parent:                        i,
	}
}
...
type aggregatedDiscoveryInterfaceWrapper struct {
	DiscoveryInterfaceWithContext
	parent AggregatedDiscoveryInterface
}
...
func (i aggregatedDiscoveryInterfaceWrapper) GroupsAndMaybeResourcesWithContext(ctx context.Context) (*metav1.APIGroupList, map[schema.GroupVersion]*metav1.APIResourceList, map[schema.GroupVersion]error, error) {
	return i.parent.GroupsAndMaybeResources()
}
...
func CachedDiscoveryInterface2Context(i CachedDiscoveryInterface) CachedDiscoveryInterfaceWithContext {
	if i == nil {
		return nil
	}
...
func ServerGroupsInterface2Context(i ServerGroupsInterface) ServerGroupsInterfaceWithContext {
	if i == nil {
		return nil
	}
...
func ServerResourcesInterface2Context(i ServerResourcesInterface) ServerResourcesInterfaceWithContext {
	if i == nil {
		return nil
	}
...
type serverResourcesInterfaceWrapper struct {
	parent ServerResourcesInterface
}
...
func (i serverResourcesInterfaceWrapper) ServerResourcesForGroupVersionWithContext(ctx context.Context, groupVersion string) (*metav1.APIResourceList, error) {
	return i.parent.ServerResourcesForGroupVersion(groupVersion)
}
...
func (i serverResourcesInterfaceWrapper) ServerGroupsAndResourcesWithContext(ctx context.Context) ([]*metav1.APIGroup, []*metav1.APIResourceList, error) {
	return i.parent.ServerGroupsAndResources()
}
...
func (i serverResourcesInterfaceWrapper) ServerPreferredResourcesWithContext(ctx context.Context) ([]*metav1.APIResourceList, error) {
	return i.parent.ServerPreferredResources()
}
...
func (i serverResourcesInterfaceWrapper) ServerPreferredNamespacedResourcesWithContext(ctx context.Context) ([]*metav1.APIResourceList, error) {
	return i.parent.ServerPreferredNamespacedResources()
}
...
func ServerVersionInterface2Context(i ServerVersionInterface) ServerVersionInterfaceWithContext {
	if i == nil {
		return nil
	}
...
func OpenAPISchemaInterface2Context(i OpenAPISchemaInterface) OpenAPISchemaInterfaceWithContext {
	if i == nil {
		return nil
	}
...
func OpenAPIV3SchemaInterface2Context(i OpenAPIV3SchemaInterface) OpenAPIV3SchemaInterfaceWithContext {
	if i == nil {
		return nil
	}
...
type openAPIV3SchemaInterfaceWrapper struct {
	parent OpenAPIV3SchemaInterface
}

func (i openAPIV3SchemaInterfaceWrapper) OpenAPIV3WithContext(ctx context.Context, ) openapi.ClientWithContext {
	return OpenAPIClient2Context(i.parent.OpenAPIV3())
}

func OpenAPIClient2Context(i openapi.Client) openapi.ClientWithContext {
	if i == nil {
		return nil
	}
...
type openAPIClientWrapper struct {
	parent openapi.Client
}

func (i openAPIClientWrapper) PathsWithContext(ctx context.Context) (map[string]openapi.GroupVersion, error) {
	return i.parent.Paths()
}
...
func ServerGroupsAndResources(d DiscoveryInterface) ([]*metav1.APIGroup, []*metav1.APIResourceList, error) {
	return ServerGroupsAndResourcesWithContext(context.Background(), DiscoveryInterface2Context(d))
}
...
func ServerGroupsAndResourcesWithContext(ctx context.Context, d DiscoveryInterfaceWithContext) ([]*metav1.APIGroup, []*metav1.APIResourceList, error) {
	...
	if !ok {
		if ad2, ok2 := d.(AggregatedDiscoveryInterface); ok2 {
			ad = AggregatedDiscoveryInterface2Context(ad2)
			ok = true
		}
	}
	if ok {
...
func ServerPreferredResources(d DiscoveryInterface) ([]*metav1.APIResourceList, error) {
	return ServerPreferredResourcesWithContext(context.Background(), DiscoveryInterface2Context(d))
}
...
func ServerPreferredNamespacedResources(d DiscoveryInterface) ([]*metav1.APIResourceList, error) {
	return ServerPreferredNamespacedResourcesWithContext(context.Background(), DiscoveryInterface2Context(d))
}
