...
var clustertrustbundlesResource = v1beta1.SchemeGroupVersion.WithResource("clustertrustbundles")

var clustertrustbundlesKind = v1beta1.SchemeGroupVersion.WithKind("ClusterTrustBundle")
...
func (c *FakeClusterTrustBundles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ClusterTrustBundle, err error) {
	emptyResult := &v1beta1.ClusterTrustBundle{}
	obj, err := c.Fake.
		Invokes(testing.NewRootGetActionWithOptions(clustertrustbundlesResource, name, options), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1beta1.ClusterTrustBundle), err
}

// List takes label and field selectors, and returns the list of ClusterTrustBundles that match those selectors.
func (c *FakeClusterTrustBundles) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ClusterTrustBundleList, err error) {
	emptyResult := &v1beta1.ClusterTrustBundleList{}
	obj, err := c.Fake.
	...
	list := &v1beta1.ClusterTrustBundleList{ListMeta: obj.(*v1beta1.ClusterTrustBundleList).ListMeta}
	for _, item := range obj.(*v1beta1.ClusterTrustBundleList).Items {
...
func (c *FakeClusterTrustBundles) Create(ctx context.Context, clusterTrustBundle *v1beta1.ClusterTrustBundle, opts v1.CreateOptions) (result *v1beta1.ClusterTrustBundle, err error) {
	emptyResult := &v1beta1.ClusterTrustBundle{}
	obj, err := c.Fake.
...
func (c *FakeClusterTrustBundles) Update(ctx context.Context, clusterTrustBundle *v1beta1.ClusterTrustBundle, opts v1.UpdateOptions) (result *v1beta1.ClusterTrustBundle, err error) {
	emptyResult := &v1beta1.ClusterTrustBundle{}
	obj, err := c.Fake.
...
func (c *FakeClusterTrustBundles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(clustertrustbundlesResource, name, opts), &v1beta1.ClusterTrustBundle{})
	return err
}
...
func (c *FakeClusterTrustBundles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.ClusterTrustBundleList{})
	return err
}

// Patch applies the patch and returns the patched clusterTrustBundle.
func (c *FakeClusterTrustBundles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterTrustBundle, err error) {
	emptyResult := &v1beta1.ClusterTrustBundle{}
	obj, err := c.Fake.
...
func (c *FakeClusterTrustBundles) Apply(ctx context.Context, clusterTrustBundle *certificatesv1beta1.ClusterTrustBundleApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ClusterTrustBundle, err error) {
